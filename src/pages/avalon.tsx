...
const Avalon: NextPage = () => {
     ...
     * For this page, the prefix is: "avalon-"
     */
    return (
        <main id="avalon-main" style={{ padding: 24, fontFamily: 'system-ui, sans-serif' }}>
            <h1 id="avalon-title">Avalon</h1>
            <p id="avalon-status">Working In Progress</p>
        </main>
    )
}
